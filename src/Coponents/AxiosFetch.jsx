...
export default function AxiosFetch() {
  return (
    <>
    <div> <center><b style={{color:"red",fontSize :"26px"}}>Axios Fetch Differences:</b></center></div>
    <table border="1px" color ='grey'>
        <tr>
            <th style={{color:"green"}}>AXIOS</th>
            <th  style={{color:"green"}}>FETCH</th>
        </tr>
        <tr>
